<template>
  <div>
    <el-card class="main-card-box">
        ...
        <el-form class="g-tool-form" :inline="true">
          <div class="g-tool-form-left">
            ...
            <el-form-item label="学期">
              <el-date-picker v-model="dateRangeValue" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" size="small" style="width: 200px"></el-date-picker>
            </el-form-item>
            <el-form-item label="月份">
              <el-date-picker v-model="dateValue" type="month" placeholder="选择月份" size="small" style="width: 200px"> </el-date-picker>
            </el-form-item>
            <el-form-item>
          ...
          <div>
            <el-form-item>
              <el-button icon="el-icon-document" type="primary" size="small"> 导出 </el-button>
            </el-form-item>
          </div>
        </el-form>
      </div>
      ...
      <el-table :data="tableData" stripe style="width: 100%" header-cell-class-name="table-header" cell-class-name="table-cell-style">
        <el-table-column type="index" label="序号" width="180"> </el-table-column>
        <el-table-column prop="teacherName" label="老师" width="180"> </el-table-column>
        ...
        <el-table-column prop="video" label="操作">
          <template>
            <div @click="dialogVisible = true" style="cursor: pointer"><i class="el-icon-document-add" style="margin-right: 2px"></i>查看详情</div>
          </template>
        </el-table-column>
      </el-table>

      <el-pagination background :current-page="1" :page-size="10" layout="total, sizes, prev, pager, next, jumper" :total="400"> </el-pagination>
    </el-card>
      ...
      <el-form class="g-tool-form" :inline="true">
        <div class="g-tool-form-left">
          ...
          <el-form-item class="middle-form-item" label="操作时间">
            <el-date-picker v-model="operationTime" type="date" size="small" style="width: 200px"></el-date-picker>
          </el-form-item>
        </div>
        <div class="g-tool-form-right">
          <el-form-item class="form-tool1">
            <el-button icon="el-icon-document-add" type="primary" size="small">导出</el-button>
          </el-form-item>
          <el-form-item class="form-tool2">
            <el-button icon="el-icon-document" type="primary" size="small">查询</el-button>
          </el-form-item>
        </div>
      </el-form>

      <el-table :data="dialogTableData" stripe style="width: 100%; margin-top: 18px" header-cell-class-name="table-header" cell-class-name="table-cell-style">
        ...
        <el-table-column label="状态">
          <template slot-scope="scope">
            <div class="tag-box">
              <el-tag v-for="(item, index) in scope.row.status" :key="index" size="medium" :type="item === '录制' ? 'warning' : ''">{{ item }}</el-tag>
            </div>
          </template>
        </el-table-column>
        <el-table-column prop="date" label="操作时间"> </el-table-column>
        <el-table-column prop="duration" label="操作时长（主讲/录制）"> </el-table-column>
      </el-table>
