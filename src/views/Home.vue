<template>
  <el-container class="body-container">
    ...
    <el-container>
      ...
      <el-main>
        <div class="navTab">
          <el-tag v-for="value in tagList" :key="value[0]" :to="value[1].path" closable :effect="activePath === value[1].path ? 'dark' : 'light'" @close="handleCloseTag(value[1].title)" @click="goto(value[1].path)" style="cursor: pointer">
            {{ value[1].title }}
          </el-tag>
